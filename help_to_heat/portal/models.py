...
class ScottishEpcRating(utils.TimeStampedModel):
    ...
    rating = models.CharField(max_length=32, choices=epc_rating_choices)
    date = models.DateField(blank=True, null=True)
    property_type = models.CharField(max_length=32, null=True)
    address1 = models.CharField(max_length=64, null=True)
    address2 = models.CharField(max_length=64, null=True)
    address3 = models.CharField(max_length=64, null=True)
    postcode = models.CharField(max_length=10, null=True)
    building_reference_number = models.CharField(max_length=12, null=True)
    potential_rating = models.CharField(max_length=4, null=True)
    current_energy_efficiency_rating = models.CharField(max_length=4, null=True)
    potential_energy_efficiency_rating = models.CharField(max_length=4, null=True)
    built_form = models.CharField(max_length=32, null=True)
    inspection_date = models.CharField(max_length=16, null=True)
    local_authority = models.CharField(max_length=64, null=True)
    constituency = models.CharField(max_length=64, null=True)
    energy_consumption = models.CharField(max_length=8, null=True)
    potential_energy_consumption = models.CharField(max_length=8, null=True)
    co2_emissions = models.CharField(max_length=8, null=True)
    co2_emissions_per_floor_area = models.CharField(max_length=8, null=True)
    co2_emissions_potential = models.CharField(max_length=8, null=True)
    floor_area = models.CharField(max_length=8, null=True)
    floor_level = models.CharField(max_length=16, null=True)
    floor_height = models.CharField(max_length=8, null=True)
    energy_tariff = models.CharField(max_length=32, null=True)
    mains_gas = models.CharField(max_length=4, null=True)
    multiple_glazed_proportion = models.CharField(max_length=4, null=True)
    extension_count = models.CharField(max_length=4, null=True)
    habitable_room_count = models.CharField(max_length=4, null=True)
    heated_room_count = models.CharField(max_length=4, null=True)
    floor_description = models.CharField(max_length=64, null=True)
    floor_energy_efficiency = models.CharField(max_length=16, null=True)
    windows_description = models.CharField(max_length=64, null=True)
    wall_description = models.CharField(max_length=64, null=True)
    wall_energy_efficiency = models.CharField(max_length=16, null=True)
    wall_environmental_efficiency = models.CharField(max_length=16, null=True)
    main_heating_description = models.CharField(max_length=64, null=True)
    main_heating_energy_efficiency = models.CharField(max_length=16, null=True)
    main_heating_environmental_efficiency = models.CharField(max_length=16, null=True)
    main_heating_fuel_type = models.CharField(max_length=64, null=True)
    second_heating_description = models.CharField(max_length=64, null=True)
    second_heating_energy_efficiency = models.CharField(max_length=16, null=True)
    roof_description = models.CharField(max_length=64, null=True)
    roof_energy_efficiency = models.CharField(max_length=16, null=True)
    roof_environmental_efficiency = models.CharField(max_length=16, null=True)
    lighting_description = models.CharField(max_length=64, null=True)
    lighting_energy_efficiency = models.CharField(max_length=16, null=True)
    lighting_environmental_efficiency = models.CharField(max_length=16, null=True)
