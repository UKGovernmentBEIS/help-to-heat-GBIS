...
class ScottishEpcRating(utils.TimeStampedModel):
    ...
    built_form = models.TextField(null=True)
    inspection_date = models.CharField(max_length=16, null=True)
    local_authority = models.TextField(null=True)
    constituency = models.TextField(null=True)
    energy_consumption = models.CharField(max_length=16, null=True)
    potential_energy_consumption = models.CharField(max_length=16, null=True)
    co2_emissions = models.CharField(max_length=16, null=True)
    co2_emissions_per_floor_area = models.CharField(max_length=16, null=True)
    co2_emissions_potential = models.CharField(max_length=16, null=True)
    floor_area = models.CharField(max_length=16, null=True)
    floor_level = models.TextField(null=True)
    floor_height = models.CharField(max_length=16, null=True)
    energy_tariff = models.TextField(null=True)
    mains_gas = models.TextField(null=True)
    ...
    floor_description = models.TextField(null=True)
    floor_energy_efficiency = models.TextField(null=True)
    windows_description = models.TextField(null=True)
    wall_description = models.TextField(null=True)
    wall_energy_efficiency = models.TextField(null=True)
    wall_environmental_efficiency = models.TextField(null=True)
    main_heating_description = models.TextField(null=True)
    main_heating_energy_efficiency = models.TextField(null=True)
    main_heating_environmental_efficiency = models.TextField(null=True)
    main_heating_fuel_type = models.TextField(null=True)
    second_heating_description = models.TextField(null=True)
    second_heating_energy_efficiency = models.TextField(null=True)
    roof_description = models.TextField(null=True)
    roof_energy_efficiency = models.TextField(null=True)
    roof_environmental_efficiency = models.TextField(null=True)
    lighting_description = models.TextField(null=True)
    lighting_energy_efficiency = models.TextField(null=True)
    lighting_environmental_efficiency = models.TextField(null=True)
    mechanical_ventilation = models.TextField(null=True)
    construction_age_band = models.TextField(null=True)
    tenure = models.TextField(null=True)
