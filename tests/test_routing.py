...
from help_to_heat.frontdoor.routing import country_field, country_field_england, supplier_page, country_field_wales, \
    country_field_scotland, country_field_northern_ireland, northern_ireland_ineligible_page, get_next_page, \
    country_page, supplier_field_british_gas, supplier_field_utility_warehouse, supplier_field_utilita, \
    supplier_field_shell, supplier_field_scottish_power, supplier_field_ovo, supplier_field_octopus, \
    supplier_field_foxglove, supplier_field_eon_next, supplier_field_edf, supplier_field_e, supplier_field_bulb, \
    own_property_page, bulb_warning_page, supplier_field, park_home_page, own_property_field_own_property, \
    own_property_field_tenant, own_property_field_social_housing, own_property_field_landlord, own_property_field, \
    field_yes, field_no, address_page, park_home_main_residence_page, park_home_field, utility_warehouse_warning_page, \
    park_home_ineligible_page, park_home_main_residence_field, address_choice_field_write_address, epc_select_page, \
    address_select_page, address_choice_field, address_choice_field_enter_manually, address_manual_page, \
    epc_select_choice_field_select_epc, epc_select_choice_field_epc_api_fail, epc_select_choice_field_enter_manually, \
    epc_select_choice_field, own_property_fields_non_social_housing, epc_page, council_tax_band_page, \
    referral_already_submitted_page, address_select_choice_field, \
    address_select_choice_field_select_address, address_select_choice_field_enter_manually, benefits_page, \
    property_type_page, duplicate_uprn_field, epc_found_field, epc_accept_suggested_epc_field, \
    epc_rating_is_eligible_field, benefits_field, summary_page, household_income_page, epc_ineligible_page, \
    household_income_field_less_than_threshold, household_income_field_more_than_threshold, property_ineligible_page, \
    household_income_field, council_tax_band_field, council_tax_band_field_a, council_tax_band_field_b, \
    council_tax_band_field_c, council_tax_band_field_d, council_tax_band_field_e, council_tax_band_field_f, \
    council_tax_band_field_g, council_tax_band_field_h, council_tax_band_field_i, property_type_field, \
    property_type_field_park_home, property_type_field_house, property_type_field_apartment, \
    property_type_field_bungalow, property_subtype_page, property_subtype_field, field_dont_know, \
    property_subtype_field_top_floor, property_subtype_field_middle_floor, property_subtype_field_ground_floor, \
    property_subtype_field_detached, property_subtype_field_semi_detached, property_subtype_field_terraced, \
    property_subtype_field_end_terrace, number_of_bedrooms_page, number_of_bedrooms_field_studio, \
    number_of_bedrooms_field_one, number_of_bedrooms_field_two, number_of_bedrooms_field_three_or_more, \
    number_of_bedrooms_field, wall_type_page, wall_type_field_solid, wall_type_field_cavity, wall_type_field_mix, \
    wall_type_field_not_listed, wall_type_field_dont_know, wall_type_field, wall_insulation_page, \
    wall_insulation_field_yes, wall_insulation_field_some, wall_insulation_field_no, wall_insulation_field_dont_know, \
...
@pytest.mark.parametrize("country, expected_next_page", [
...
@pytest.mark.parametrize("supplier, expected_next_page", [
...
@pytest.mark.parametrize("own_property, expected_next_page", [
...
@pytest.mark.parametrize("park_home, expected_next_page", [
...
@pytest.mark.parametrize("park_home_main_residence, expected_next_page", [
...
@pytest.mark.parametrize("choice, duplicate_uprn, expected_next_page", [
    (epc_select_choice_field_select_epc, field_no, epc_page),
    (epc_select_choice_field_epc_api_fail, field_no, address_select_page),
    (epc_select_choice_field_enter_manually, field_no, address_manual_page),
    ...
    (epc_select_choice_field_enter_manually, field_yes, address_manual_page),
])
...
@pytest.mark.parametrize("choice, duplicate_uprn, epc_found, expected_next_page", [
...
@pytest.mark.parametrize("flow, expected_next_page", [
    (flow_park_home, benefits_page),
    (flow_main, benefits_page),
...
def test_address_manual_next_page(flow, expected_next_page):
    for flow_answers in _get_flow_answers(flow):
        assert get_next_page(address_manual_page, flow_answers) == expected_next_page


@pytest.mark.parametrize("flow, epc_found, expected_next_page", [
...
@pytest.mark.parametrize("epc_found, expected_next_page", [
    (field_yes, epc_page),
...
@pytest.mark.parametrize("flow, eligible, expected_next_page", [
...
@pytest.mark.parametrize("flow, benefits, expected_next_page", [
...
@pytest.mark.parametrize("household_income", [
...
ineligible_council_tax_bands_scotland = [
    council_tax_band_field_f, council_tax_band_field_g, council_tax_band_field_h
]
...
ineligible_council_tax_bands_wales = [
    council_tax_band_field_f, council_tax_band_field_g, council_tax_band_field_h, council_tax_band_field_i
]


@pytest.mark.parametrize("household_income, country, council_tax_bands, expected_next_page", [
    (household_income_field_less_than_threshold, country_field_england, eligible_council_tax_bands_england, property_type_page),
    (household_income_field_more_than_threshold, country_field_england, eligible_council_tax_bands_england, property_type_page),
    (household_income_field_less_than_threshold, country_field_england, ineligible_council_tax_bands_england, property_type_page),
    (household_income_field_more_than_threshold, country_field_england, ineligible_council_tax_bands_england, property_ineligible_page),
    (household_income_field_less_than_threshold, country_field_scotland, eligible_council_tax_bands_scotland, property_type_page),
    (household_income_field_more_than_threshold, country_field_scotland, eligible_council_tax_bands_scotland, property_type_page),
    (household_income_field_less_than_threshold, country_field_scotland, ineligible_council_tax_bands_scotland, property_type_page),
    (household_income_field_more_than_threshold, country_field_scotland, ineligible_council_tax_bands_scotland, property_ineligible_page),
    (household_income_field_less_than_threshold, country_field_wales, eligible_council_tax_bands_wales, property_type_page),
    (household_income_field_more_than_threshold, country_field_wales, eligible_council_tax_bands_wales, property_type_page),
    (household_income_field_less_than_threshold, country_field_wales, ineligible_council_tax_bands_wales, property_type_page),
    (household_income_field_more_than_threshold, country_field_wales, ineligible_council_tax_bands_wales, property_ineligible_page),
])
...
@pytest.mark.parametrize("property_subtype", [
...
@pytest.mark.parametrize("number_of_bedrooms", [
...
@pytest.mark.parametrize("wall_type", [
...
@pytest.mark.parametrize("wall_insulation", [
...
@pytest.mark.parametrize("loft, expected_next_page", [
...
@pytest.mark.parametrize("loft_access", [
...
@pytest.mark.parametrize("loft_insulation", [
